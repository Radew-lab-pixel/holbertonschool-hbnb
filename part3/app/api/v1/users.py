...
"""initalize Bcrypt"""
# bcrypt = Bcrypt(app)  already initialized in /app/__init__.py

# Define the user model aka presentation layer  for input validation and documentation
...
class UserList(Resource):
    ...
    def post(self):
        ...
        new_user.hash_password(user_data['password']) # update password to hash_password
