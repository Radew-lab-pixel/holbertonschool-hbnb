...
class HBnBFacade:
    ...
    def get_user_by_id(self, _id) -> Union[User, None]:
        ...
        return self.user_repository.get(_id)
    ...
    def update_user(self, _id, data) -> User:
        ...
        self.user_repository.update(_id, data)
    ...
    def create_review(self, text: str, rating: int, place_id: str, user_id: str) -> Review:
        ...
        self.place_repository.update(place_id, {"reviews": place.reviews})
        self.user_repository.update(user_id, {"reviews": user.reviews})
        return review
    ...
    def delete_review(self, review_id: str) -> None:
        ...
        self.place_repository.update(review.place.id, {"reviews": review.place.reviews})
        self.user_repository.update(review.user.id, {"reviews": review.user.reviews})
